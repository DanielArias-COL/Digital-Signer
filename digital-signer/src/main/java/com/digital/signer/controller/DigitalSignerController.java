...
public class DigitalSignerController {
    ...
    @PostMapping("/user/signSharingFile")
    public ResponseEntity<Object> signSharingFile(HttpServletRequest request, @ModelAttribute SignShareFileDTO signedFileDTO) {
        try {
            return Util.getResponseSuccessful(this.digitalSignerService.signSharingFile(request, signedFileDTO));
        } catch (Exception e) {
            return Util.getResponseError(DigitalSignerController.class.getSimpleName() + ".signSharingFile ", e.getMessage());
        }
    }
    ...
    @PostMapping("/user/listSharesFilesSigned")
    public ResponseEntity<Object> listSharesFilesSigned(HttpServletRequest request, @RequestBody GetidDTO getidDTO) {
        try {
            return Util.getResponseSuccessful(this.digitalSignerService.listSharesFilesSigned(request, getidDTO));
        } catch (Exception e) {
            return Util.getResponseError(DigitalSignerController.class.getSimpleName() + ".listMySharesFile ", e.getMessage());
        }
    }
